...
if(window.innerWidth > 1000 ) {
  ...
  videoContainer.addEventListener("mouseenter", function () {
    videoContainer.addEventListener("mousemove", function (dets) {
      ...
      gsap.to("#video-cursor", {
        left: dets.x - 570,
        y: dets.y  + scrollY - videoRect.top,
      });
    });
  });
  ...
  document.querySelectorAll("#page3 .image-div").forEach((elem)=>{
...
let anime1 = gsap.to("#footer h1 span", {
  opacity: 0,
  stagger: 0.03,
  duration:0.2,
  paused: true
})
let anime2 =  gsap.to("#footer h2 span", {
  delay: 0.35,
  opacity: 1,
  duration:0.2,
  stagger: 0.03,
...
locomotiveAnimation();
sheryAnimation();
if(window.innerWidth >= 1000 ){flagAnimation()}
if(window.innerWidth >= 1000 ){footerAnimation()}